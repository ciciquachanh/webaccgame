                     ...
                     <div class="col-sm-3 col-xs-6 p-5">
                        <div class="classWithPad">
                           ...
                           <div class="news_title">
                              <h2>
                                 <a href="{{route('dichvucon','nick-lien-quan')}}" title="Danh Mục Game Liên Quân">Danh Mục Game Liên Quân</a>
                              </h2>
                           </div>
                              ...
                              <div class="row">
                                 <div class="col-xs-12">
                                    <div class="custom72 view">
                                       <a href="{{route('dichvucon','nick-lien-quan')}}" class="" title="Danh Mục Game Liên Quân">
                                          &nbsp;
                                          <style type="text/css">
                                             .custom72{
